...
char *voc_names[] = {"aeroplane", "bicycle", "bird", "boat", "bottle", "bus", "car", "cat", "chair", "cow", "diningtable", "dog", "horse", "motorbike", "person", "pottedplant", "sheep", "sofa", "train", "tvmonitor","barrel","birdnest"};
image voc_labels[NCLASSES];
...
void train_yolo(char *cfgfile, char *weightfile)
{
    ...
    clock_t time;
    //while(i*imgs #include <cv.h>< N*120){
...
void test_yolo(char *cfgfile, char *weightfile, char *filename, float thresh)
{
    ...
    while(1){
        ...
        //draw_detections(im, l.side*l.side*l.n, thresh, boxes, probs, voc_names, voc_labels, NCLASSES);
        draw_detections(im, l.side*l.side*l.n, thresh, boxes, probs, voc_names, 0, NCLASSES);
